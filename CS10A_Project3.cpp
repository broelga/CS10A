...
/////////////////////////////////////////////////////////////////////
// Function is the main program. All other function calls are
// from this function. The user will be prompted with a menu and
// given options. The program will call the function that is chosen
// by user. After function has comepleted, it ill return to main()
// where the status of running will be checked. If running is true,
// this function will be called again from main().
/////////////////////////////////////////////////////////////////////
unsigned programMenu(int someArray[], int limit)
{
    // Pre:     Prompt user with menu options.
    // Post:    Uses switch statement to call specified option. Returns to main() when complete.
    // Declare variables
    unsigned choice = 0;
    bool isValid; // Bool to return to main(). If user has not chosen to quit, program will restart.
    ...
    do
    {
        ...
        if (choice > 0 && choice < 11)
            ...
            case 1: /* Read 10 scores from user */
                getScores(someArray, limit);
                break;
            case 2: /* Read 10 scores from file */
                readScores(someArray, limit);
                break;
            case 3: /* Print all scores */
                printScores(someArray, limit);
                break;
            case 4: /* Print the highest score */
                printHighestScore(someArray, limit);
                break;
            case 5: /* Print the lowest score */
                printLowestScore(someArray, limit);
                break;
...
void getScores(int someArray[], int limit)
{
    ...
    // Post:    Once all scores have been input, function returns to programMenu().
    // Declare variables
    bool isValid;
...
void readScores(int someArray[], int limit)
{
    ...
    // Post:    Verify correct filename and read data and store into array. Return to programMenu().
    // Declare variables
    string filename;
    ifstream inFile;
...
void printHighestScore(const int someArray[], int limit)
{
    ...
    //          score is displayed to user. Returns to programMenu().
    // Declare variable
    unsigned highest = 0;
...
// user. Returns to programMenu().
/////////////////////////////////////////////////////////////////////
void printAverageScore(const int someArray[], int limit)
{
    // Pre:     Iterate through scores and accumulate each score.
    // Post:    cast the score and assign the average to variable. Display average and return to programMenu().
    // Declare variables
    unsigned sum = 0;
    float average;
...
// displayed to user and returns to programMenu().
/////////////////////////////////////////////////////////////////////h
void searchForValue(int someArray[], int limit)
{
    ...
    //          Data is displayed to user and returns to programMenu().
    // Declare variables.
...
// then displayed. Returns to programMenu().
/////////////////////////////////////////////////////////////////////
void printOneScore(const int someArray[], int limit)
{
    ...
    //          Display higher counter and return to programMenu().
    // Declare variables
    unsigned entryNum,
        higherCounter = 0;
    bool isValid = false;
